...
public static class Quiz
{
    ...
    {
        return Enumerable.Range(1, (exclusiveUpperLimit >= 1) ? exclusiveUpperLimit - 1 : throw new ArgumentOutOfRangeException("Argument must be 1 or higher")).Where(x => int.IsEvenInteger(x)).ToArray();
    }
